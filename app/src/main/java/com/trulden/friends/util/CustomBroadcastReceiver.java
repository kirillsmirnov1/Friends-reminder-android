            ...
            switch (intentAction) {
                case ACTION_DATABASE_EXPORT_FINISHED:
                    if(intent.getBooleanExtra(EXTRA_EXPORT_RESULT, false)){
                        makeToast(context, context.getResources().getString(R.string.toast_notice_export_succeeded));
                    } else {
                        makeToast(context, context.getResources().getString(R.string.toast_notice_export_failed));
                    }
                ...
                case ACTION_DATABASE_IMPORT_FINISHED:
                    if(intent.getBooleanExtra(EXTRA_IMPORT_RESULT, false)){
                        makeToast(context, context.getResources().getString(R.string.toast_notice_import_succeeded));
                    } else {
                        makeToast(context, context.getResources().getString(R.string.toast_notice_import_failed));
                    }
